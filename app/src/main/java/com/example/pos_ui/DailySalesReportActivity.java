...
import com.example.pos_ui.Controller.DailySalesAdapter;
import com.example.pos_ui.Model.DailySalesModel;
...
public class DailySalesReportActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        dateButton = (Button) findViewById(R.id.datepicker_btn);
        initDatePicker();
        ...
        backButton.setOnClickListener(new View.OnClickListener() {
            ...
            {
                startActivity(new Intent(DailySalesReportActivity.this, ManagerHomeView.class));
            }
        });
    }
    ...
    private List<DailySalesModel> getList() {
        ...
        payment_list.add(new DailySalesModel("0001","Nail 6inches box Large","02","100"));
        payment_list.add(new DailySalesModel("0200","Rhino roofing sheets L","20","23000"));
        payment_list.add(new DailySalesModel("0563","Arpico Hybrid tank 50L","60","14000"));
        payment_list.add(new DailySalesModel("0365","Philip srews Box 100ps","20","5930"));
